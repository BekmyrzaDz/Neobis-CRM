...
import styles from './TrialLessonMade.module.scss'

ChartJS.defaults.font.family = 'Segoe UI, sans-serif'
ChartJS.defaults.color = '#252525'
ChartJS.register(Tooltip, Legend, ArcElement)

const TrialLessonMade = () => {
  const TrialLessonMadeData = useAppSelector(
    (state) => state.analytics.requestStatus[3]
  )

  const updatedData = updateReqStatusDepartmentNames(TrialLessonMadeData)
  ...
  return (
    <div className={styles.trialLessonMade}>
...
export default TrialLessonMade
